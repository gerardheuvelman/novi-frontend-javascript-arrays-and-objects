...
console.log("Hallo, ik ben " + personalInfo.firstName + ", ik ben " + personalInfo.age + " jaar oud.")
...
let description = ""
description = "Het gaat om een hele mooie " + product.productName  + ", gemaakt van " +  product.material[0]+ " en " + product.material[1] + "."
